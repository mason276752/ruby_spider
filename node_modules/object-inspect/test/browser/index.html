...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>listing directory /node_modules/object-inspect/test/browser</title>
    <style>* {
  margin: 0;
  padding: 0;
  outline: 0;
...
#files .icon-application-javascript .name {
  ...
  <body class="directory">
    ...
    <div id="wrapper">
      <h1>
<a href="/">~</a> / <a href="/node_modules">node_modules</a> / <a href="/node_modules/object-inspect">object-inspect</a> / <a href="/node_modules/object-inspect/test">test</a> / <a href="/node_modules/object-inspect/test/browser">browser</a>
</h1>
      <ul id="files" class="view-tiles">
<li><a href="/node_modules/object-inspect/test" class="icon icon-directory" title=".."><span class="name">..</span><span class="size"></span><span class="date"></span></a></li>
<li><a href="/node_modules/object-inspect/test/browser/dom.js" class="icon icon icon-js icon-application-javascript" title="dom.js"><span class="name">dom.js</span><span class="size">416</span><span class="date">8/26/2022 3:43:54 PM</span></a></li>
</ul>
    </div>
  </body>
</html>
