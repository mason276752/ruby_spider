...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>listing directory /node_modules/function-bind/test</title>
    <style>* {
  margin: 0;
  padding: 0;
  outline: 0;
...
#files .icon-application-javascript .name {
  ...
  <body class="directory">
    ...
    <div id="wrapper">
      <h1>
<a href="/">~</a> / <a href="/node_modules">node_modules</a> / <a href="/node_modules/function-bind">function-bind</a> / <a href="/node_modules/function-bind/test">test</a>
</h1>
      <ul id="files" class="view-tiles">
<li><a href="/node_modules/function-bind" class="icon icon-directory" title=".."><span class="name">..</span><span class="size"></span><span class="date"></span></a></li>
<li><a href="/node_modules/function-bind/test/index.js" class="icon icon icon-js icon-application-javascript" title="index.js"><span class="name">index.js</span><span class="size">8991</span><span class="date">8/26/2022 3:43:54 PM</span></a></li>
</ul>
    </div>
  </body>
</html>
