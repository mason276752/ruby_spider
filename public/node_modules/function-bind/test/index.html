...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>listing directory /public/node_modules/function-bind/test</title>
    <style>* {
  margin: 0;
  padding: 0;
  outline: 0;
...
#files .icon-text-html .name {
  ...
  <body class="directory">
    ...
    <div id="wrapper">
      <h1>
<a href="/">~</a> / <a href="/public">public</a> / <a href="/public/node_modules">node_modules</a> / <a href="/public/node_modules/function-bind">function-bind</a> / <a href="/public/node_modules/function-bind/test">test</a>
</h1>
      <ul id="files" class="view-tiles">
<li><a href="/public/node_modules/function-bind" class="icon icon-directory" title=".."><span class="name">..</span><span class="size"></span><span class="date"></span></a></li>
<li><a href="/public/node_modules/function-bind/test/index.html" class="icon icon icon-html icon-text-html" title="index.html"><span class="name">index.html</span><span class="size">9348</span><span class="date">8/26/2022 3:44:01 PM</span></a></li>
</ul>
    </div>
  </body>
</html>
